...
window.onscroll = () => {
  ...
  sections.forEach((section) => {
    const offsetFromTop = section.offsetTop;
    if (scrollY >= offsetFromTop -100) {
...
document.onclick = function (e) {
  ...
  if (e.target.id === "sidemenu" || e.target.id === "openmenu") {
...
////////////////// form //////////
const scriptURL =
  "https://script.google.com/macros/s/AKfycbwYsin1-RmgSk7Z2aRXfbhr_BnFVsMgbI6IcAdiFhNnhM5tLu_O5D3lBP21Xq2lBOkH/exec";
